...
export default function DetalleCaso() {
  ...
  const campos = [
    ...
    { label: "Fecha de creación", value: new Date(caso.fecha_creacion).toLocaleString(), icon: <FaClock />, color: "#d1c4e9" },
    ...(caso.estado_actual === "Cerrado" && caso.fecha_cierre
      ? [{
          label: "Fecha y hora de cierre",
          value: new Date(caso.fecha_cierre).toLocaleString(),
          icon: <FaClock style={{ color: "#1565c0" }} />,
          color: "#bbdefb",
        }]
      : []),
    ...(caso.estado_actual === "Cerrado"
      ? [{
          ...
          value: caso.tiempo_resolucion || "N/A",
          icon: (
            <FaClock
              style={{
                color: "#2e7d32",
                fontSize: "1.4rem",
                animation: "girarReloj 3s linear infinite",
              }}
            />
          ),
          color: "#c8e6c9",
  ...
  // 🔹 Función para renderizar modales
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0 }}>
              {caso.historial
                ...
                .map((h) => (
                  <li key={h.id_historial} style={{ backgroundColor: "#fff", marginBottom: "0.8rem", padding: "1rem", borderRadius: "12px", boxShadow: "0 4px 10px rgba(0,0,0,0.1)" }}>
