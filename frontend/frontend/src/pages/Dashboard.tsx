...
export default function Dashboard() {
  ...
  {/*Rutas comentadas para futuras funcionalidades */}
  <Route path="formulario-encuesta-premium" element={<FormularioEncuestaPremium />} /> 
  <Route path="reportes" element={<Reportes />} /> 
  <Route path="reporte-categoria" element={<ReporteCategoria />} />
